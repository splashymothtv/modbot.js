...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addUserOption(option => option.setName('target').setDescription('Whose warnings you want to clear').setRequired(true))
    ...
    async execute(interaction, client) {
        ...
        if (warnNum > warns) return await interaction.reply({ content: ` You can only clear ${warns} from ${member.tag}`, ephemeral: true});
