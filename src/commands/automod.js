  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((command) =>
      command
        ...
        .setDescription(
          "Blocks profanity, specific content, and slurs from being sent."
        )
    )
    .addSubcommand((command) =>
      command
      ...
      command
        ...
        .addIntegerOption((option) =>
          option
            .setName("number")
            .setDescription(
              "Specified amount will be used as the max mention amount."
            )
            .setRequired(true)
        )
    )
    ...
    switch (sub) {
      case "flagged-words":
        ...
        const rule = await guild.autoModerationRules
          .create({
            name: `Block profinity, sexual content, and slurs by ModBot.`,
            creatorId: "1005866118642159626",
            enabled: true,
            eventType: 1,
            triggerType: 4,
            triggerMetadata: {
            ...
            actions: [
              {
                ...
                metadata: {
                  ...
                  durationSeconds: 10,
                  customMessage: "This message was prevented by ModBot!",
                },
              },
            ],
          })
        ...
        setTimeout(async () => {
          ...
          const embed = new EmbedBuilder()
            ...
            .addFields({
              name: `• Automod Rule`,
              value: `> Flagged Words rule added`,
            })
            .setThumbnail(
              "https://cdn.discordapp.com/avatars/1005866118642159626/bccfb25387c5ddb442f89498ed0ea6bc.webp"
            )
      ...
      case "keyword":
        ...
        const rule2 = await guild.autoModerationRules
          .create({
            name: `Prevent the word ${word} by ModBot.`,
            creatorId: "1005866118642159626",
            enabled: true,
            eventType: 1,
            triggerType: 1,
        ...
        setTimeout(async () => {
          ...
          const embed2 = new EmbedBuilder()
            ...
            .addFields({
              name: `• Automod Rule`,
              value: `> Your automod rule has been created. Messages \n> with **${word}** will be deleted`,
            })
            .setThumbnail(
              "https://cdn.discordapp.com/avatars/1005866118642159626/bccfb25387c5ddb442f89498ed0ea6bc.webp"
            );
      ...
      case "spam-messages":
        ...
        const rule3 = await guild.autoModerationRules
          .create({
            name: "Prevent Spam Messages by ModBot.",
            creatorId: "1005866118642159626",
            enabled: true,
            eventType: 1,
            triggerType: 5,
        ...
        setTimeout(async () => {
          ...
          const embed3 = new EmbedBuilder()
            ...
            .addFields({
              name: `• Automod Rule`,
              value: `> Spam Rule added, all spam messages \n> will be deleted.`,
            })
            .setThumbnail(
              "https://cdn.discordapp.com/avatars/1005866118642159626/bccfb25387c5ddb442f89498ed0ea6bc.webp"
            );
      ...
      case "mention-spam":
        ...
        const rule4 = await guild.autoModerationRules
          .create({
            name: `Prevent Spam Mentions by ModBot.`,
            creatorId: "1005866118642159626",
            enabled: true,
            eventType: 1,
            triggerType: 5,
        ...
        setTimeout(async () => {
          ...
          const embed4 = new EmbedBuilder()
            ...
            .addFields({
              name: `• Automod Rule`,
              value: `> Spam Mention Rule added, all spam messages \n> will be deleted.`,
            })
            .setThumbnail(
              "https://cdn.discordapp.com/avatars/1005866118642159626/bccfb25387c5ddb442f89498ed0ea6bc.webp"
            );
